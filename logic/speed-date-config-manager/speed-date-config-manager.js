...
async function updateBotConfigIfNeeded(guildId, guildName, inviteImageUrl, inviteTitle, inviteText, musicUrl, musicVolume, ignoreUser){
	try {
		// TODO - make check more elegant
		if(!inviteImageUrl && !inviteTitle && !inviteText && !musicUrl && !musicVolume && !ignoreUser){
		...
		await updatedConfigFieldsForGuild(guildId, inviteImageUrl, inviteTitle, inviteText, musicUrl, musicVolume, ignoreUser);
	} catch (e) {
